...
MAX_DURATION = 180  # seconds to keep from uploaded file
...
def main():
    ...
    st.caption("For demo on Streamlit Cloud: processing limited to first 180 seconds (stereo).")
    ...
    st.subheader("🎧 Reconstructed FLAC (first 180s)")
