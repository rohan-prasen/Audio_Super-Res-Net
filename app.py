...
MAX_DURATION = 90  # seconds to keep from uploaded file
...
def main():
    ...
    st.caption("For demo on Streamlit Cloud: processing limited to first 90 seconds (stereo).")
    ...
    st.subheader("🎧 Reconstructed FLAC (first 90s)")
