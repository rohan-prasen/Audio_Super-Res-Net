...
MAX_DURATION = 120  # seconds to keep from uploaded file
...
def main():
    ...
    st.caption("For demo on Streamlit Cloud: processing limited to first 120 seconds (stereo).")
    ...
    st.subheader("🎧 Reconstructed FLAC (first 120s)")
